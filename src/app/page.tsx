import {Avatar, Specialty} from '@components/home';
...
const Page = (): JSX.Element => (
  <section className='h-[calc(100vh-4rem)]'>
    <div className='absolute h-[calc(100vh-4rem)] w-full bg-[url("/home/jumbotron.webp")] bg-cover bg-center bg-no-repeat brightness-50'></div>
    <div className='relative mx-4 flex h-full justify-center'>
      <div className='flex flex-col items-center justify-center'>
        <div className='pb-8'>
          <Avatar
            src='/home/avatar1.webp'
            easter='/home/avatar2.webp'
          />
        </div>
